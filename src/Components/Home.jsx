          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex w-full flex-wrap justify-center items-center gap-[20px]">
                <div className="flex w-[80px] p-2 h-[80px] bg-lime-300 rounded">
                  <img
                ...
                <div className="flex w-[80px] p-2 h-[80px] bg-yellow-300 rounded">
                  <img
                    className="object-contain w-full h-full"
                    src={Ads}
                    alt=""
                ...
                <div className="flex w-[80px] p-2 h-[80px] bg-pink-300 rounded">
                  <img
                    className="object-contain w-full h-full"
                    src={Studio}
                    alt=""
                ...
                <div className="flex w-[80px] p-2 h-[80px] bg-amber-500 rounded">
                  <img
                    className="object-contain w-full h-full"
                    src={Vs}
                    alt=""
                ...
                <div className="flex w-[80px] p-2 h-[80px] bg-white rounded">
                  <img
                    className="object-contain w-full h-full"
                    src={Word}
                    alt=""
